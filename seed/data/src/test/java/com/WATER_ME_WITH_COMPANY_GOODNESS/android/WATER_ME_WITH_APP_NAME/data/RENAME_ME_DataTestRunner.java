...
public class {app_class_prefix}DataTestRunner extends RobolectricGradleTestRunner {

    public {app_class_prefix}DataTestRunner(Class<?> klass) throws InitializationError {
        super(klass);
    }
